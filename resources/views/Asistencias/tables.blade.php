            ...
            <table class="table-fixed">
                <thead>
                  <tr>
                    ...
                    <th class="border w-1/4 px-4 py-2"> Total de Clases </th>
                    <th class="border w-1/2 px-4 py-2"> Fallas </th>
                    <th class="border w-1/2 px-4 py-2"> Excusas </th>
                    <th class="border w-1/2 px-4 py-2"> Detalle </th>
                  </tr>
                </thead>
                <tbody>
                    @foreach($EstudiantesFiltrados as $i)
                     <tr>
                        ...
                        <td class="border px-4 py-2">{{ $i->total_dias}}</td>
                        <td class="border px-4 py-2">{{ $i->total_dias - $i->total_asistencias}}</td>
                        <td class="border px-4 py-2">{{ $i->total_justificafiones}}</td>
